...
opts_chunk$set(fig.path='figures/KeepUseful', out.width="0.7\\textwidth") 
```  
...
If you haven't done so, set your working directory to wherever NewPackage_1.0.tar.gz was placed. For example: 
...
That should have built and installed the package for you. Gain access to
it using: 
